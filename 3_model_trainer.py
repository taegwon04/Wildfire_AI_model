...
def display_metrics(acc, report_dict):
    ...
    table_html += "<tr><th style='border:1px solid #ccc;'>클래스</th><th style='border:1px solid #ccc;'>정확도</th><th style='border:1px solid #ccc;'>재현율</th><th style='border:1px solid #ccc;'>F1 점수</th></tr>"
    for label in ["0", "1"]:
